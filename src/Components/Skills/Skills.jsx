            ...
            <div className="skills">
                <div className="row">
                    <div className="text-container mb-5">
                        <h4 className="main-text  text-center">Skills</h4>
                            ...
                            <div className="card-body">
                                <div className="body-content">
                                    <div className="content-1">
                                        ...
                                        <h4 className="skill">HTML 5</h4>
                                        <input type="range" className='slider' name="html" id="myRange-Html" min='0' max='100' value='85' disabled />
                                    </div>
                                    <br />
                                    <div className="content-2">
                                        ...
                                        <h4 className="skill">CSS 3</h4>
                                        <input type="range" className='slider' name="html" id="myRange-css" min='0' max='100' value='75' disabled />
                                    </div>
                                    <br />
                                    <div className="content-3">
                                        <div className="logo">
                                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="60" height="60" viewBox="0 0 64 64">
                                                ...
                                                </ellipse><path fill="#ffce29" d="M54,20v24c0,2.25-0.74,4.32-2,5.99V50c-1.69,2.24-4.29,3.75-7.25,3.97C44.51,53.99,44.25,54,44,54 H20c-5.52,0-10-4.48-10-10V20c0-0.25,0.01-0.51,0.03-0.75c0.22-2.96,1.73-5.56,3.97-7.25h0.01c1.67-1.26,3.74-2,5.99-2h24 C49.52,10,54,14.48,54,20z"></path>
                                    ...
                                    <div className="content-4">
                                        ...
                                        <input type="range" className='slider' name="html" id="myRange-bootstrap" min='0' max='100' value='80' disabled />
                                    </div>
                                    <br />
                                    <div className="content-4">
                                        <div className="logo">
                                        ...
                                        <h4 className="skill">Tailwind CSS</h4>
                                        <input type="range" className='slider' name="html" id="myRange-tailwind" min='0' max='100' value='40' disabled />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="card-body">
                                <div className="body-content">
                                    <div className="content-1">
                                        ...
                                        <h4 className="skill">React Js</h4>
                                        <input type="range" className='slider' name="html" id="myRange-react" min='0' max='100' value='70' disabled />
                                    </div>
                                    <br />
                                    <div className="content-2">
                                        <div className="logo">
                                        ...
                                        <input type="range" className='slider' name="html" id="myRange-node" min='0' max='100' value='70' disabled />
                                    </div>
                                    <br />
                                    <div className="content-2">
                                        <div className="logo">
                                        ...
                                        <h4 className="skill">Express Js</h4>
                                        <input type="range" className='slider' name="html" id="myRange-express" min='0' max='100' value='70' disabled />
                                    </div>
                                    <br />
                                    <div className="content-3">
                                        <div className="logo">
                                        ...
                                        <h4 className="skill">Mongo DB</h4>
                                        <input type="range" className='slider' name="html" id="myRange-mongo" min='0' max='100' value='70' disabled />
                                    </div>
                                    <br />
                                    <div className="content-4">
                                        <div className="logo">
                                        ...
                                        <input type="range" className='slider' name="html" id="myRange-sql" min='0' max='100' value='60' disabled />
                                    </div>
                                </div>
                            </div>
                        </div>
